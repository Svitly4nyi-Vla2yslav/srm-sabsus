...
import LinieBackground from '../../../assets/icons/Inventory/iPadMini.png';
      ...
      <LifeContainer>
        ...
        >
          <LifeMainTextDescription>
            Track stock, transfers, and supplies in one smart system. Monitor
            ingredients, packaging, and prep kits with instant updates across
            all venues.
          </LifeMainTextDescription>
        </motion.div>
      </LifeContainer>
