  ...
  return (
    <HowWeWorkWrapper>
      ...
      <HowWeWorkMainid
        ...
        viewport={{ once: false, amount: 0.3 }}
      >
        From order to ready light — organized, fast, and clear
      </HowWeWorkMainid>
      <motion.div
        initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      >
        <HowWeWorkMainTextDescription>
          The kitchen and fulfillment system brings precision to your
          back-of-house flow. Here’s how your team stays in sync:
        </HowWeWorkMainTextDescription>
      </motion.div>
      <HowWeWorkContainer>
