...
import keys from '../../../assets/icons/Kitchen/key.png';
import keys1 from '../../../assets/icons/Kitchen/key1.png';
import keys2 from '../../../assets/icons/Kitchen/key2.png';
import keys3 from '../../../assets/icons/Kitchen/key3.png';
import keys4 from '../../../assets/icons/Kitchen/key4.png';
import keys5 from '../../../assets/icons/Kitchen/key5.png';
import keys6 from '../../../assets/icons/Kitchen/key6.png';
import keys7 from '../../../assets/icons/Kitchen/key7.png';
            ...
            {keyItems.map(item => (
              <SwiperSlide key={item.id}>
                <Card>
                  <Icon
                    src={item.imageUrl}
                    alt={t(`kitchenManagement1.cards.${item.key}.title`)}
                  />
                  <TitleCard>
                    {t(`kitchenManagement1.cards.${item.key}.title`)}
                  </TitleCard>
                  <TextCard>
                    {t(`kitchenManagement1.cards.${item.key}.desc`)}
                  </TextCard>
                </Card>
              </SwiperSlide>
            ))}
